...
def cms_NAT(ak,aks,region,instanceID,metric):
    ...
    request.add_query_param('Project','acs_nat_gateway')
...
#    print response
    if metric=="SnatConnection":
    	print response['Datapoints'][len(response['Datapoints'])-1]
    else:
...
if __name__ == '__main__':
    if len(sys.argv)<2:
        ...
        metric=sys.argv[1]
        cms_NAT(ak,aks,region,instanceID,metric)
